		...
		<div class="container-fluid">
			...
			<div class="nav-collapse collapse">
				<ul class="nav">
					...
					<li class="divider-vertical"></li>
					<li class="active"><a href="atendidos.php"><img src="../images/checkicon.png"/> Pedidos Finalizados</a></li>
					<li class="divider-vertical"></li>
    ...
    <table class="table">
      <thead>
        <tr>
		  ...
		  <th>Quantidade</th>
          <th>Mesa</th>
          <th style="width: 36px;">Atendente</th>
        </tr>
      </thead>';
$sql0 = mysql_query("SELECT * FROM pedidos WHERE status =1", $conexao);
				while($linha = mysql_fetch_array($sql0)){
					...
					$sql2 = mysql_query("SELECT nome FROM sistema WHERE id = '".$atendente."'", $conexao);
						while($linha = mysql_fetch_array($sql2)){
						$atendente = $linha['nome'];
						}
